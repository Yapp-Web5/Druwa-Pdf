/*! react-scroll-trigger v0.3.7 | (c) 2018 Ryan Hefner | MIT License | https://github.com/ryanhefner/react-scroll-trigger !*/
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['react', 'react-dom'], factory) :
  (global['react-scroll-trigger'] = factory(global.React,global.ReactDOM));
  ...
  */
  ...
  function (_Component) {
    ...
    function ScrollTrigger(props) {
      ...
      _this.onScroll = lodash_throttle(_this.onScroll.bind(_assertThisInitialized(_assertThisInitialized(_this))), props.throttleScroll, {
        trailing: false
      });
      _this.onResize = lodash_throttle(_this.onResize.bind(_assertThisInitialized(_assertThisInitialized(_this))), props.throttleResize, {
        trailing: false
      });
      _this.state = {
        inViewport: false,
    ...
    _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
      if (nextProps.throttleScroll !== this.props.throttleScroll) {
        this.onScroll = lodash_throttle(this.onScroll.bind(this, nextProps.throttleScroll));
        addEventListener('scroll', this.onScroll);
      }

      if (nextProps.throttleResize !== this.props.throttleResize) {
        this.onResize = lodash_throttle(this.onResize.bind(this, nextProps.throttleResize));
        addEventListener('resize', this.onResize);
      }
    };
